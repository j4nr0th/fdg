 ...
 *
 * Interpolates the positions and transformations of the space map onto an uniform grid
 * using Lagrange nodal basis. If the order for each dimension is at at least as high
 * as the original order used for the space map, this is exact.
 *
 *
