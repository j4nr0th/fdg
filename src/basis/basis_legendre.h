...
/**
 * @brief Create a Legendre basis set evaluated at the nodes of an integration rule.
 *
 * The created basis set holds the values and first derivatives of the
 * `spec.order + 1` Legendre basis functions at the integration nodes.
 *
 ...
 *        basis is always created as a Legendre basis.
 ...
 */
FDG_INTERNAL
fdg_result_t legendre_basis_create(basis_set_t **out, basis_spec_t spec, const integration_rule_t *rule,
